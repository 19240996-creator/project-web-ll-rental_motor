...
<?php $__env->startSection('title', 'Catat Pengembalian'); ?>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('pengembalian.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        
                        <div class="form-group mb-3">
                            <label for="Id_pengembalian" class="form-label">ID Pengembalian</label>
                            <input type="text" class="form-control <?php $__errorArgs = ['Id_pengembalian'];
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php $__errorArgs = ['Id_pengembalian'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select <?php $__errorArgs = ['Id_transaksi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="Id_transaksi" name="Id_transaksi" required>
                                ...
                                <?php $__currentLoopData = $transaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaksi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($transaksi->Id_transaksi); ?>">
                                        <?php echo e($transaksi->Id_transaksi); ?> - <?php echo e($transaksi->user->name); ?> (<?php echo e($transaksi->motor->Merk_motor); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['Id_transaksi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control <?php $__errorArgs = ['Biaya_keterlambatan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('pengembalian.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJECT AKHIR WEB II\project-web-ll-rental_motor\resources\views/pengembalian/create.blade.php ENDPATH**/ ?>