...
<?php $__env->startSection('title', 'Tambah Motor'); ?>
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('motor.store')); ?>" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['Id_motor'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control <?php $__errorArgs = ['Plat_nomor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJECT AKHIR WEB II\project-web-ll-rental_motor\resources\views/motor/create.blade.php ENDPATH**/ ?>