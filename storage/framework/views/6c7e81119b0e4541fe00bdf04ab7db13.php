                    ...
                    <div class="card h-100 shadow-sm border-0 transaction-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <?php elseif($transaction->metode_pembayaran === 'qr'): ?>
                                    <span class="badge bg-info"><i class="fas fa-qrcode"></i> QR Code</span>
                                <?php elseif($transaction->metode_pembayaran === 'bank'): ?>
                                    <span class="badge bg-warning text-dark"><i class="fas fa-university"></i> <?php echo e($transaction->bank_tujuan ?? 'Transfer Bank'); ?></span>
                                <?php else: ?>
                            ...
                            <?php if($transaction->metode_pembayaran === 'bank' && $transaction->bank_tujuan): ?>
                            ...
                            <?php if($transaction->metode_pembayaran === 'qr' && $transaction->qr_code): ?>
                                <div class="mb-3" style="text-align: center;">
                                    <small class="text-muted d-block"><i class="fas fa-qrcode"></i> Kode QR Pembayaran</small>
                                    <img src="<?php echo e($transaction->qr_code); ?>" alt="QR Code" style="max-width: 120px; height: auto; border: 2px solid #ddd; padding: 8px; border-radius: 8px; margin-top: 8px;" />
                                </div>
                            <?php endif; ?>
