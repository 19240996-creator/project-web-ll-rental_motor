...
<?php $__env->startSection('title', 'Login Customer - Rental Motor'); ?>
...
<div class="login-wrapper">
    <div class="login-card">
        ...
        <div class="login-body">
            ...
            <form action="<?php echo e(route('customer.login.post')); ?>" method="POST" novalidate id="loginForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-footer">
            ...
            <p style="margin-top: 15px; border-top: 1px solid #ddd; padding-top: 15px;">
                <a href="<?php echo e(route('login')); ?>">Login sebagai Admin?</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJECT AKHIR WEB II\project-web-ll-rental_motor\resources\views/auth/customer-login.blade.php ENDPATH**/ ?>