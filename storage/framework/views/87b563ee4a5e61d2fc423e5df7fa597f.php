...
<?php $__env->startSection('title', 'Edit Profile - Rental Motor'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      name="alamat" 
                                      rows="3"
                                      placeholder="Masukkan alamat lengkap Anda"><?php echo e(old('alamat', $user->alamat)); ?></textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="grid-2col">
                            <div class="form-group">
                                ...
                                <select class="form-control <?php $__errorArgs = ['tipe_identitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="KTP" <?php echo e(old('tipe_identitas', $user->tipe_identitas) === 'KTP' ? 'selected' : ''); ?>>KTP</option>
                                    <option value="SIM" <?php echo e(old('tipe_identitas', $user->tipe_identitas) === 'SIM' ? 'selected' : ''); ?>>SIM</option>
                                    <option value="Paspor" <?php echo e(old('tipe_identitas', $user->tipe_identitas) === 'Paspor' ? 'selected' : ''); ?>>Paspor</option>
                                </select>
                                <?php $__errorArgs = ['tipe_identitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       class="form-control <?php $__errorArgs = ['no_identitas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="no_identitas" 
                                       name="no_identitas" 
                                       value="<?php echo e(old('no_identitas', $user->no_identitas)); ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo e(route('profile.destroy')); ?>" method="POST" id="deleteForm" novalidate>
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJECT AKHIR WEB II\project-web-ll-rental_motor\resources\views/profile/edit.blade.php ENDPATH**/ ?>