...
<?php $__env->startSection('title', 'Daftar - Rental Motor'); ?>
...
<div class="register-wrapper">
    <div class="register-card">
        ...
        <div class="register-body">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST" novalidate id="registerForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="register-footer">
            <p>Sudah punya akun? 
                <a href="<?php echo e(route('customer.login')); ?>" style="color: #667eea; text-decoration: none; font-weight: 600;">Login di sini</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\PROJECT AKHIR WEB II\project-web-ll-rental_motor\resources\views/auth/register.blade.php ENDPATH**/ ?>