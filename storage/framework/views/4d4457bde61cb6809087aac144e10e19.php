        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-auth btn-login" href="<?php echo e(route('login')); ?>">
                            <i class="fas fa-sign-in-alt"></i> Login Admin
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-auth btn-register" href="<?php echo e(route('register')); ?>">
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-auth-buttons">
                    <a href="<?php echo e(route('customer.login')); ?>" class="hero-auth-btn hero-auth-btn-login">
                        <i class="fas fa-sign-in-alt"></i> Saya Sudah Punya Akun (LOGIN)
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="hero-auth-btn hero-auth-btn-register">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="fleet-item">
                        ...
                        <a href="<?php echo e(route('customer.login')); ?>" class="btn btn-light btn-sm">
...
<?php /**PATH C:\PROJECT AKHIR WEB II\project-web-ll-rental_motor\resources\views/welcome.blade.php ENDPATH**/ ?>