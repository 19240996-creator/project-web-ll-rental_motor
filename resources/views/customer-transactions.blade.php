                            ...
                            <div class="row align-items-center" style="position: relative; z-index: 2;">
                                <div class="col">
                                    <h6 class="mb-0 text-white">
                                        <i class="fas fa-motorcycle"></i> {{ $transaction->motor->Merk_motor ?? 'Motor' }}
                                    </h6>
                                    <small class="text-white-50">{{ $transaction->motor->Warna_motor ?? 'N/A' }} | {{ $transaction->motor->Plat_nomor ?? 'N/A' }}</small>
                                </div>
                                <div class="col-auto">
                                    @php
